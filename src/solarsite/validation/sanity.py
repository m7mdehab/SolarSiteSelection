...
* Specific yield — World Bank/ESMAP/Solargis *Global Photovoltaic Power Potential
  ...
  5.0 kWh/kWp" (≈1,095-1,825 kWh/kWp/yr) — verbatim from the report. Hard fixed-tilt
  ceiling ~2,200; we use [500, 2600] as a deliberately wide *certainly-a-bug*
  envelope (not a point figure).
